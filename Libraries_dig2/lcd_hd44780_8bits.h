 ...
 * HD44780, operando en modo de 8 BITS (cada byte, comando o dato, se
 * envia completo de una sola vez por las lineas D0-D7).
 *
 * Esta libreria NO esta atada a ningun microcontrolador en particular.
 * El usuario debe implementar 4 funciones "callback" que controlan
 * los pines fisicos (RS, EN, D0-D7) y los delays de su plataforma
...
#ifndef LCD_HD44780_8BITS_H
#define LCD_HD44780_8BITS_H
 ...
 *
 * El usuario debe llenar los 4 punteros a funcion con su propia
...
typedef struct {
    ...
    /* Escribe un byte completo en las lineas D0-D7 del LCD */
...
/* ---------------------------------------------------------------------
 * API publica (identica en firma a la version de 4 bits, para que se
 * pueda cambiar de una a otra sin reescribir el codigo de aplicacion)
 * --------------------------------------------------------------------- */

/* Inicializa el LCD siguiendo el algoritmo de inicializacion de 8 bits.
